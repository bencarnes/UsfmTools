...
const usfmSearchTheme = EditorView.baseTheme({
  ...
  ".cm-panels-top, &.cm-light .cm-panels-top, &.cm-dark .cm-panels-top": {
    position: "absolute",
    top: 0,
    left: 0,
    right: 0,
  ...
  ".cm-search.usfm-search-panel": {
    ...
    backgroundColor: "var(--usfm-search-panel-bg)",
    border: "1px solid var(--usfm-search-panel-border)",
    borderRadius: "6px",
  ...
  ".usfm-search-expand-btn": {
    ...
    width: "28px",
    minHeight: "28px",
    borderRight: "1px solid var(--usfm-search-panel-border)",
  ...
  ".usfm-search-field": {
    ...
    margin: 0,
    border: "1px solid var(--usfm-search-field-border)",
    borderRadius: "4px",
    backgroundColor: "var(--usfm-search-field-bg)",
    color: "inherit",
    font: "inherit",
    outline: "none",
  },
  ".usfm-search-field:focus": {
    borderColor: "var(--usfm-search-field-focus)",
  },
  ...
  ".usfm-search-btn:hover": {
    backgroundColor: "var(--usfm-search-btn-hover)",
  },
  ".usfm-search-mode-btn--on": {
    backgroundColor: "var(--usfm-search-mode-on-bg)",
    border: "1px solid var(--usfm-search-mode-on-border)",
    color: "var(--usfm-search-mode-on-fg)",
  },
