...
Preview HTML regeneration is debounced (1.5 s) in split mode. Scroll sync is paused during typing and resumes after 500 ms idle. Remaining per-keystroke cost is dominated by the controlled-editor React update chain and full-document validation/highlighting.
